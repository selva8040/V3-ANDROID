...
class NSP_PROM_BOX_List : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addsalary.setOnClickListener{
            val k= Intent(this@NSP_PROM_BOX_List, NSP_Prom_BOX_FORM::class.java).putExtra("from", from)
            startActivity(k)
            finish()
