...
import com.elancier.healthzone.Adapter.PurchaseReportAdapter;
...
public class PurchaseReport extends MainView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setclick(drawer_layout, drawerLayout, PurchaseReport.this);
        LinearLayout reportlay = (LinearLayout) findViewById(R.id.purchase_lay);
    ...
    private class GetInfoTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... param) {
            ...
            try {
                ...
                Log.i("utilsInput", Appconstants.PURCHASE_LIST + "    " + jobj.toString());
                result = con.sendHttpPostjson2(Appconstants.PURCHASE_LIST, jobj, "");
            ...
            try {
                if (resp != null) {
                    ...
                    if (obj1.getString("Status").equals("Success")) {
                        ...
                        for (int i = 0; i < jarr.length(); i++) {
                            ...
                            bo.setStoreid(jobj.getString("storeid").toString().trim().equalsIgnoreCase("null") ? "" : jobj.getString("storeid"));
                            bo.setSname(jobj.getString("sname").toString().trim().equalsIgnoreCase("null") ? "" : jobj.getString("sname"));
                            // bo.setSmobile("");
                        ...
                        if (adapter == null) {
                            adapter = new PurchaseReportAdapter(PurchaseReport.this, R.layout.purchase_report, data);
                ...
                if (start == 0) {
                    ...
                    Toast.makeText(getApplicationContext(), "No More Data.", Toast.LENGTH_SHORT).show();
                        ...
                        /*SalesReportAdapter adapter = new SalesReportAdapter(PurchaseReport.this, R.layout.purchase_report, data);
                        listView.setAdapter(adapter);
