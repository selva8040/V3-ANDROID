...
import com.elancier.healthzone.Adapter.PairMatchBonusAdapter;
...
public class PairMatchBonus extends MainView {
    ArrayList<SponsorBonusBo> sponsorlist;
    ReportsPojo pojo;
    ListView listView;
    PairMatchBonusAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (scrollValue && scrollNeed && (sponsorlist.size()>0)) {
                    ...
                    if(from_date.getText().toString().trim().length()>0&&to_date.getText().toString().trim().length()>0){
                        ...
                        if(dateval>0) {
                            adapter = null;
                            sponsorlist = new ArrayList<SponsorBonusBo>();
                            adapter = new PairMatchBonusAdapter(PairMatchBonus.this, R.layout.pair_match_bonus_item, sponsorlist);
        ...
        from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                picker = new Dialog(PairMatchBonus.this);
        ...
        search_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(from_date.getText().toString().trim().length()>0&&to_date.getText().toString().trim().length()>0){
                    ...
                    Toast.makeText(PairMatchBonus.this,"From and To date fields should not be empty",Toast.LENGTH_SHORT).show();
                }
    ...
    private class GetInfoTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... param) {
            ...
            try {
                ...
                Log.i("utilsInput", Appconstants.PAIR_MATCH_BONUS+"    "+jobj.toString());
                result = con.sendHttpPostjson2(Appconstants.PAIR_MATCH_BONUS,jobj,"");
                ...
                if (resp != null) {
                    ...
                    if (obj1.getString("Status").equals("Success")) {
                        ...
                        for(int i=0;i<jarr.length();i++) {
                            ...
                            bo.setSpoint(jobj.getString("bonus_point").toString().trim().equalsIgnoreCase("null")?"0:0":jobj.getString("bonus_point"));
