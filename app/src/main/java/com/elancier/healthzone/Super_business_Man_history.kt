    ...
    inner class RewardpointsAsync : AsyncTask<String, String, String>() {
        ...
        override fun doInBackground(vararg strings: String): String? {
            ...
            try {
                ...
                Log.i("rewardinput", Appconstants.superbusiness + "    " + jobj.toString())
                ...
                if (resp != null) {
                    ...
                    if(obj.getString("Status").equals("Success")) {
                        ...
                        for (i in 0 until arrayLanguage.length()) {
                            ...
                            val feedback_present1 = JO.getString("user7")
                            val feedback_present2 = JO.getString("user8")
                            val feedback_present3 = JO.getString("user9")
