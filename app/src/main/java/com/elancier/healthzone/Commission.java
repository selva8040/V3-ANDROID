...
import com.elancier.healthzone.Adapter.CommissionAdapter;
...
public class Commission  extends MainView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (scrollValue && scrollNeed && (sponsorlist.size()>0)) {
                    ...
                    if(from_date.getText().toString().trim().length()>0&&to_date.getText().toString().trim().length()>0){
                        ...
                        if(dateval>0) {
                            adapter = null;
                            sponsorlist = new ArrayList<PinBo>();
                            adapter = new CommissionAdapter(Commission.this, R.layout.prime_super_pin_item, sponsorlist);
        ...
        from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                picker = new Dialog(Commission.this);
        ...
        search_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(from_date.getText().toString().trim().length()>0&&to_date.getText().toString().trim().length()>0){
                    ...
                    Toast.makeText(Commission.this,"From and To date fields should not be empty",Toast.LENGTH_SHORT).show();
                }
        ...
        protected String doInBackground(String... param) {
            ...
            try {
               ...
               /* jobj.put("from",param[0]);
                ...
                Log.i("check Input", Appconstants.COMMISSION_API+"    "+jobj.toString());
                result = con.sendHttpPostjson2(Appconstants.COMMISSION_API,jobj,"");
                ...
                if (resp != null) {
                    ...
                    if (obj1.getString("Status").equals("Success")) {
                        ...
                        for(int i=0;i<jarr.length();i++) {
                            ...
                            bo.setWhom(jobj.getString("whome").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("whome"));
                            // bo.setSaleid(jobj.getString("salesid").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("salesid"));
                            bo.setAmount(jobj.getString("amount").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("amount"));
                            sponsorlist.add(bo);

                        }
                        if(adapter==null) {
                            adapter = new CommissionAdapter(Commission.this, R.layout.commission_list_items, sponsorlist);
                            listView.setAdapter(adapter);
                        }
                        else{
