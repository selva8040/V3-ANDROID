...
import com.elancier.healthzone.Adapter.BonusAdapter;
...
public class BonusReports extends MainView {

    DrawerLayout drawerLayout;
    LinearLayout drawer_layout,reports_lay,bonus_reports_lay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bonus_reports);
                ...
                if (scrollValue && scrollNeed && (data.size()>0)) {
                    ...
                    if(from_date.getText().toString().trim().length()>0&&to_date.getText().toString().trim().length()>0){
                        ...
                        if(dateval>0) {
                            ...
                            adapter = new BonusAdapter(BonusReports.this, R.layout.bonus_item, data);
    ...
    private void init() {
        ...
        setclick(drawer_layout, drawerLayout, BonusReports.this);
        reports_lay = (LinearLayout) findViewById(R.id.ibv_reports_lay);
        ...
        bonus_reports_lay.setBackgroundColor(getResources().getColor(R.color.eee));
    ...
    private void onclick() {
        ...
        from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                picker = new Dialog(BonusReports.this);
        ...
        search_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(from_date.getText().toString().trim().length()>0&&to_date.getText().toString().trim().length()>0){
                    ...
                    Toast.makeText(BonusReports.this,"From and To date fields should not be empty",Toast.LENGTH_SHORT).show();
                }
                ...
                if (resp != null) {
                    ...
                    if (obj1.getString("Status").equals("Success")) {
                        ...
                        for(int i=0;i<jarr.length();i++) {
                            ...
                            bo.setUsername(jobj.getString("name").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("name"));
                            ...
                            bo.setBonus(jobj.getString("bv").toString().trim().equalsIgnoreCase("null")?"0.00":jobj.getString("bv"));
                            bo.setIbv(jobj.getString("value").toString().trim().equalsIgnoreCase("null")?"0.00":jobj.getString("value"));
                            data.add(bo);
