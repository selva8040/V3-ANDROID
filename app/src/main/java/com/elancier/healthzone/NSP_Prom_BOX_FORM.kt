...
class NSP_Prom_BOX_FORM : AppCompatActivity() {
       ...
       /* if(utils.loadfirstversion()=="true"){
        ...
        if(utils.pb_uname().isNotEmpty()){
            if(utils.pb_uname()!=utils.loadName()){
                ...
                utils.savePreferences("nspb_uname3","")
                utils.savePreferences("nspb_uname","")

            }
        }

        if(utils.loadnspb_uname1().isNotEmpty()){
            uname.setText(utils.loadnspb_uname1())
        }

        if(utils.loadnspb_uname2().isNotEmpty()){
            custname.setText(utils.loadnspb_uname2())
        }
        if(utils.loadnspb_uname3().isNotEmpty()){
            user3.setText(utils.loadnspb_uname3())
        }
        ...
        if(utils.loadnspb_uname1().isNotEmpty()&&
            utils.loadnspb_uname2().isNotEmpty()&&
            utils.loadnspb_uname3().isNotEmpty())
        {
...
/*        utils.savePreferences("gd_uname1",uname.text.toString().trim())
    ...
    private inner class stateload : AsyncTask<String, Void, String>() {
        ...
        override fun onPreExecute() {
            ...
            pDialo = ProgressDialog(this@NSP_Prom_BOX_FORM);
                ...
                if (resp != null) {
                    ...
                    if (json.getString("Status") == "Success") {
                        ...
                        if(curentxt=="uname"){
                            // uname.setText("")
                            //click=""
                            utils.savePreferences("nspb_uname1",uname.text.toString().trim())
                            utils.savePreferences("nspb_uname",utils.loadName())
                            ...
                            //  custname.setText("")
                            utils.savePreferences("nspb_uname2",custname.text.toString().trim())
                            utils.savePreferences("nspb_uname",utils.loadName())
                            //utils.savePreferences("clearversion","false")
                            ...
                            // user3.setText("")
                            utils.savePreferences("nspb_uname3",user3.text.toString().trim())
                            utils.savePreferences("nspb_uname",utils.loadName())
                            //utils.savePreferences("clearversion","false")
    ...
    private inner class savetask : AsyncTask<String, String, String>() {
        ...
        override fun onPreExecute() {
            progbar = Dialog(this@NSP_Prom_BOX_FORM)
            ...
            try {
                if (resp != null) {
                    ...
                    if(jarray.getString("Status").equals("Success")){
                        ...
                        val k= Intent(this@NSP_Prom_BOX_FORM,NSP_PROM_BOX_List::class.java)
                        startActivity(k)
                        finish()
                    }
                    else{
