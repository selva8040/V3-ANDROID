...
public class NSP_Wallet extends MainView {
    ...
    private class GetInfoTask extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... param) {
            ...
            try {
                ...
                jobj.put("type", "Wallet");
                jobj.put("uname",utils.loadName());


                Log.i("utilsInput", Appconstants.nsp_activation+"    "+jobj.toString());
            ...
            try {
                if (resp != null) {
                    ...
                    if (json.getString("Status").equals("Success")) {
                        ...
                        WalletBookAdapter adapter=new WalletBookAdapter(NSP_Wallet.this,R.layout.wallet_book_list_item,passlist);
