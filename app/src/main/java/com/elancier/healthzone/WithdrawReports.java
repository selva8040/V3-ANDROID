...
import com.elancier.healthzone.Adapter.WithdrawAdapter;
...
public class WithdrawReports extends MainView {

    DrawerLayout drawerLayout;
    LinearLayout drawer_layout,reports_lay,withdraw_reports_lay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_withdraw_reports);
                    ...
                    if(from_date.getText().toString().trim().length()>0&&to_date.getText().toString().trim().length()>0){
                       ...
                       GetInfoTask task=new GetInfoTask();
                        ...
                        if(dateval>0) {
                            ...
                            adapter = new WithdrawAdapter(WithdrawReports.this, R.layout.withdraw_item, data);
    ...
    private void init() {
        ...
        setclick(drawer_layout, drawerLayout, WithdrawReports.this);
        ...
        withdraw_reports_lay.setBackgroundColor(getResources().getColor(R.color.eee));
    ...
    private void onclick() {
        ...
        from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                picker = new Dialog(WithdrawReports.this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                successdialog(data.get(position).getFrombank(),data.get(position).getTid(),data.get(position).getTobank(),
                        data.get(position).getAptime());
            }
        });
        ...
        search_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(from_date.getText().toString().trim().length()>0&&to_date.getText().toString().trim().length()>0){
                    ...
                    Toast.makeText(WithdrawReports.this,"From and To date fields should not be empty",Toast.LENGTH_SHORT).show();
                }
    ...
    private void successdialog(String str1,String str2,String str3,String str4) {

       Dialog dialog1 = new Dialog(WithdrawReports.this);
        dialog1.requestWindowFeature(Window.FEATURE_NO_TITLE);
        View popup = getLayoutInflater().inflate(R.layout.withdrae_popup, null);

       TextView frombank = (TextView) popup.findViewById(R.id.fbank);
        TextView trid = (TextView) popup.findViewById(R.id.tid);
        TextView tobank = (TextView) popup.findViewById(R.id.tobank);
        TextView approvedate = (TextView) popup.findViewById(R.id.apdate);
        ...
        dialog1.show();
        frombank.setText(str1+"");
        trid.setText(str2+"");
        tobank.setText(str3+"");
        approvedate.setText(str4+"");
    ...
    private class GetInfoTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... param) {
            ...
            try {
                ...
                //Log.i("check Input", Appconstants.GET_MY_WITHDRAW_REPORTS+"    "+jobj.toString());
                result = con.sendHttpPostjson2(Appconstants.GET_MY_WITHDRAW_REPORTS,jobj,"");
                ...
                if (resp != null) {
                    ...
                    if (obj1.getString("Status").equals("Success")) {
                        ...
                        for(int i=0;i<jarr.length();i++) {
                            ...
                            bo.setUserid(jobj.getString("receivable").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("receivable"));
                            bo.setTid(jobj.getString("tid").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("tid"));
                            bo.setFrombank(jobj.getString("frombank").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("frombank"));
                            bo.setTobank(jobj.getString("tobank").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("tobank"));
                            bo.setAptime(jobj.getString("atime").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("atime"));
                            ...
                            bo.setIbv(jobj.getString("tds").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("tds"));
                            data.add(bo);
