...
import com.elancier.healthzone.Adapter.GbvReportsAdapter;
...
public class GbvReports extends MainView {

    DrawerLayout drawerLayout;
    LinearLayout drawer_layout,reports_lay,gbv_reports_lay;
    ArrayList<ReportsPojo> data;
    ReportsPojo pojo;
    ListView listView;
    GbvReportsAdapter adapter;
                ...
                if (scrollValue && scrollNeed && (data.size()>0)) {
                    ...
                    if(from_date.getText().toString().trim().length()>0&&to_date.getText().toString().trim().length()>0){
                        ...
                        if(dateval>0) {
                            ...
                            adapter = new GbvReportsAdapter(GbvReports.this, R.layout.gbv_items, data);
    ...
    private void init() {
        ...
        setclick(drawer_layout, drawerLayout, GbvReports.this);
        ...
        gbv_reports_lay.setBackgroundColor(getResources().getColor(R.color.eee));
       ...
       /* for (int i = 0; i< name.length; i++){
        ...
        adapter = new ReportsAdapter(GbvReports.this,R.layout.reports_list_items,data);
        listView.setAdapter(adapter);*/
    }
    ...
    private void onclick() {
        ...
        from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                picker = new Dialog(GbvReports.this);
        ...
        search_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(from_date.getText().toString().trim().length()>0&&to_date.getText().toString().trim().length()>0){
                    ...
                    Toast.makeText(GbvReports.this,"From and To date fields should not be empty",Toast.LENGTH_SHORT).show();
                }
    ...
    private class GetInfoTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... param) {
            ...
            try {
                ...
                //Log.i("check Input", Appconstants.GET_MY_GBV_REPORTS+"    "+jobj.toString());
                result = con.sendHttpPostjson2(Appconstants.GET_MY_GBV_REPORTS,jobj,"");
                ...
                if (resp != null) {
                    ...
                    if (obj1.getString("Status").equals("Success")) {
                        ...
                        for(int i=0;i<jarr.length();i++) {
                            ...
                            bo.setUsername(jobj.getString("funame").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("funame"));
                            bo.setName(jobj.getString("fname").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("fname"));
                            bo.setDate(jobj.getString("date").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("date"));
                            bo.setDate(jobj.getString("per").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("per"));
                            bo.setAmount(jobj.getString("amount").toString().trim().equalsIgnoreCase("null")?"0.00":jobj.getString("amount"));
                            bo.setIbv(jobj.getString("bv").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("bv"));
                            data.add(bo);
