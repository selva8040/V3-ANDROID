...
public class ServerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ServerAdapter(List<Object> mRecyclerViewItems, Context context, OnItemClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        switch (viewType) {
            ...
            default:
                View productView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.serveritems, viewGroup, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (viewType) {
            ...
            default:
                ...
                ((ItemViewHolder) holder).date.setText("Down Time - "+item.getDate());
                ...
                ((ItemViewHolder) holder).whome.setText("Whome - "+item.getWhome());
                ((ItemViewHolder) holder).whomename.setText("Whomename - "+item.getWhomename());
