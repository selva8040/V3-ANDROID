 ...
 */
public class PnameSpinnerAdapter extends BaseAdapter {
   ...
   ArrayList<ProductBo> items;
    ...
    public PnameSpinnerAdapter(Context context, int resource, ArrayList<ProductBo> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.text.setText(items.get(position).getPname());
