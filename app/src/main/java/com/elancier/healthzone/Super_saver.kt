...
class Super_saver : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(BuildConfig.VERSION_CODE==42&&utils.loadfirstversion2().isEmpty()){
            utils.savePreferences("clearversion2","true")
        }


        if(utils.loadfirstversion2()=="true"){
            utils.savePreferences("nr_uname1","")
            utils.savePreferences("nr_uname2","")
            utils.savePreferences("nr_uname3","")
            utils.savePreferences("nr_uname4","")
            utils.savePreferences("nr_uname5","")
            utils.savePreferences("nr_uname6","")
            utils.savePreferences("nr_uname","")
        }

        if(utils.nr_uname().isNotEmpty()){
            if(utils.nr_uname()!=utils.loadName()){
                utils.savePreferences("nr_uname1","")
                utils.savePreferences("nr_uname2","")
                utils.savePreferences("nr_uname3","")
                utils.savePreferences("nr_uname4","")
        ...
        if(utils.loadnr_uname1().isNotEmpty()){
            uname.setText(utils.loadnr_uname1())
        }

        if(utils.loadnr_uname2().isNotEmpty()){
            custname.setText(utils.loadnr_uname2())
        }
        if(utils.loadnr_uname3().isNotEmpty()){
            user3.setText(utils.loadnr_uname3())
        }
        if(utils.loadnr_uname4().isNotEmpty()){
            user4.setText(utils.loadnr_uname4())
        }
        if(utils.loadnr_uname5().isNotEmpty()){
            user5.setText(utils.loadnr_uname5())
        }
        if(utils.loadnr_uname6().isNotEmpty()){
            user6.setText(utils.loadnr_uname6())
        }
                ...
                if (Caption.text.toString().trim { it <= ' ' }.length > 0) {
                    ...
                    if(custname.text.toString()!=Caption.text.toString()&&
                       ...
                       user6.text.toString()!=Caption.text.toString()){
                        if(utils.loadnr_uname1().isEmpty()) {
                            val task = stateload()
            ...
            if (!hasFocus) {
                ...
                if (Caption.text.toString().trim { it <= ' ' }.length > 0) {
                    ...
                    if(uname.text.toString()!=Caption.text.toString()&&
                            ...
                            user5.text.toString()!=Caption.text.toString()&&
                            user6.text.toString()!=Caption.text.toString()) {
                        if(utils.loadnr_uname2().isEmpty()) {
            ...
            if (!hasFocus) {
                ...
                if (Caption.text.toString().trim { it <= ' ' }.length > 0) {
                    if(uname.text.toString()!=Caption.text.toString()&&
                        ...
                        if(utils.loadnr_uname3().isEmpty()) {
                            val task = stateload()
            ...
            if (!hasFocus) {
                ...
                if (Caption.text.toString().trim { it <= ' ' }.length > 0) {
                    if(uname.text.toString()!=Caption.text.toString()&&
                            ...
                            user5.text.toString()!=Caption.text.toString()&&
                            user6.text.toString()!=Caption.text.toString()) {
                        if(utils.loadnr_uname4().isEmpty()) {
            ...
            if (!hasFocus) {
                ...
                if (Caption.text.toString().trim { it <= ' ' }.length > 0) {
                        ...
                        if(uname.text.toString()!=Caption.text.toString()&&
                                ...
                                user4.text.toString()!=Caption.text.toString()&&
                                user6.text.toString()!=Caption.text.toString()) {
                            if(utils.loadnr_uname5().isEmpty()) {
            ...
            if (!hasFocus) {
                ...
                if (Caption.text.toString().trim { it <= ' ' }.length > 0) {
                    if(uname.text.toString()!=Caption.text.toString()&&
                            ...
                            user4.text.toString()!=Caption.text.toString()&&
                            user5.text.toString()!=Caption.text.toString()) {
                        if(utils.loadnr_uname6().isEmpty()) {
        ...
        button8.setOnClickListener {
            ...
            if (uname.text.toString().isNotEmpty() &&
                ...
                if(utils.loadnr_uname6().isEmpty()) {
                    ...
                    val task = stateload()
                    task.execute(user6.text.toString().trim { it <= ' ' }, "user6")
                }
    ...
    private inner class stateload : AsyncTask<String, Void, String>() {
        ...
        override fun onPreExecute() {
            ...
            pDialo = ProgressDialog(this@Super_saver);
        ...
        override fun doInBackground(vararg param: String): String? {
            ...
            try {
                ...
                Log.i("check Input", Appconstants.startperf + "    " + jobj.toString())
                    ...
                    if (json.getString("Status") == "Success") {
                       ...
                       // uname.setText(states)
                        ...
                        if(curentxt=="uname"){
                           // uname.setText("")
                            //click=""
                            utils.savePreferences("nr_uname1",uname.text.toString().trim())
                            utils.savePreferences("nr_uname",utils.loadName())
                            utils.savePreferences("clearversion2","false")
                          ...
                          //  custname.setText("")
                            utils.savePreferences("nr_uname2",custname.text.toString().trim())
                            utils.savePreferences("nr_uname",utils.loadName())
                            utils.savePreferences("clearversion2","false")
                           ...
                           // user3.setText("")
                            utils.savePreferences("nr_uname3",user3.text.toString().trim())
                            utils.savePreferences("nr_uname",utils.loadName())
                            utils.savePreferences("clearversion2","false")
                           ...
                           // user4.setText("")
                            utils.savePreferences("nr_uname4",user4.text.toString().trim())
                            utils.savePreferences("nr_uname",utils.loadName())
                            utils.savePreferences("clearversion2","false")
                            ...
                            //user5.setText("")
                            utils.savePreferences("nr_uname5",user5.text.toString().trim())
                            utils.savePreferences("nr_uname",utils.loadName())
                            utils.savePreferences("clearversion2","false")
                            ...
                            //user6.setText("")
                            utils.savePreferences("nr_uname6",user6.text.toString().trim())
                            utils.savePreferences("nr_uname",utils.loadName())
                            utils.savePreferences("clearversion2","false")
    ...
    private inner class savetask : AsyncTask<String, String, String>() {
        ...
        override fun onPreExecute() {
            progbar = Dialog(this@Super_saver)
