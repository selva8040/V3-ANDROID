...
import com.elancier.healthzone.Adapter.PrimeBonusAdapter;
...
public class PrimeBonusActivity extends MainView{

    ArrayList<PinBo> sponsorlist;
    ReportsPojo pojo;
    ListView listView;
    PrimeBonusAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getExtras().getInt("flag")==1){
            getSupportActionBar().setTitle("Fast Track Bonus Details");
            API=Appconstants.FAST_BONUS;
        }
        else if(getIntent().getExtras().getInt("flag")==2){
            getSupportActionBar().setTitle("Prime Super Bonus Details");
            API=Appconstants.PRIME_BONUS;
        }
        else if(getIntent().getExtras().getInt("flag")==3){
            getSupportActionBar().setTitle("Pro Star Bonus Details");
            API=Appconstants.PRO_BONUS;
        }
        scrollNeed = true;
        start=0;
        limit=20;
                ...
                if (scrollValue && scrollNeed && (sponsorlist.size()>0)) {
                    ...
                    if(from_date.getText().toString().trim().length()>0&&to_date.getText().toString().trim().length()>0){
                        ...
                        if(dateval>0) {
                            adapter = null;
                            sponsorlist = new ArrayList<PinBo>();
                            adapter = new PrimeBonusAdapter(PrimeBonusActivity.this, R.layout.prime_bonus_details_item, sponsorlist);
        ...
        from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                picker = new Dialog(PrimeBonusActivity.this);
        ...
        search_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(from_date.getText().toString().trim().length()>0&&to_date.getText().toString().trim().length()>0){
                    ...
                    Toast.makeText(PrimeBonusActivity.this,"From and To date fields should not be empty",Toast.LENGTH_SHORT).show();
                }
                ...
                if (resp != null) {
                    ...
                    if (obj1.getString("Status").equals("Success")) {
                        ...
                        for(int i=0;i<jarr.length();i++) {
                            ...
                            bo.setPinno(jobj.getString("amount").toString().trim().equalsIgnoreCase("null")?"0":jobj.getString("amount"));
                            bo.setSaleid(jobj.getString("position").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("position"));
                            bo.setPinstatus(jobj.getString("dtime").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("dtime"));
                            sponsorlist.add(bo);
