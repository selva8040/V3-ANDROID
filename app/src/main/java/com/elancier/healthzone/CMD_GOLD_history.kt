...
class CMD_GOLD_history : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "CMD GOLD REQUEST"
        ...
        swipeToRefresh.setOnRefreshListener(object : SwipeRefreshLayout.OnRefreshListener {
            override fun onRefresh() {
                //shuffle()
                finish()
                startActivity(Intent(this@CMD_GOLD_history,CMD_GOLD_history::class.java))
    ...
    inner class RewardpointsAsync : AsyncTask<String, String, String>() {
        ...
        override fun doInBackground(vararg strings: String): String? {
            ...
            try {
                ...
                Log.i("rewardinput", Appconstants.gold + "    " + jobj.toString())
