...
class New_recharge_List_Dup : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "Super Salary Request"
        ...
        swipeToRefresh.setOnRefreshListener(object : SwipeRefreshLayout.OnRefreshListener {
            override fun onRefresh() {
                //shuffle()
                finish()
                startActivity(Intent(this@New_recharge_List_Dup,New_recharge_List_Dup::class.java))
        ...
        addsalary.setOnClickListener{
            try {
                println("check_tod : "+check_tod)
                 update = Dialog(this@New_recharge_List_Dup)
                ...
                up.setText("Super Salary Request")//sk
               ...
               // otp_edit_box1!!.setText(otp_edit_box1str)
                ...
                otp_edit_box1!!.setOnClickListener {
                    ...
                    // date picker dialog
                    picker = DatePickerDialog(this@New_recharge_List_Dup,
                        DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth ->
                            ...
                            if (!otp_edit_box2!!.text.toString().isEmpty()) {
                                if (CheckNetwork.isInternetAvailable(this@New_recharge_List_Dup)) {
                                    //start = 0
                                    // limit = 20
    ...
    inner class RewardpointsAsync : AsyncTask<String, String, String>() {
        override fun onPreExecute() {
            ...
            pdialog = ProgressDialog(this@New_recharge_List_Dup)
        ...
        override fun doInBackground(vararg strings: String): String? {
            ...
            try {
                ...
                Log.i("rewardinput",  Appconstants.sal_req + "    " + jobj.toString())
    ...
    inner class ChangepinTask :
        ...
        override fun doInBackground(vararg params: String?): String? {
            ...
            try {
                ...
                jobj.put("to", otp_edit_box12!!.text.toString())
                jobj.put("type","Add")
    ...
    fun clikffed(pos: String, time: String,time1:String ,time2:String) {
        try {
            val update = Dialog(this@New_recharge_List_Dup)
            update.requestWindowFeature(Window.FEATURE_NO_TITLE)
            update.window!!.setBackgroundDrawable(
                ColorDrawable(Color.WHITE)
            )
