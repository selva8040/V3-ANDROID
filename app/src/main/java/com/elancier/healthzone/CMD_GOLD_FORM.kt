...
class CMD_GOLD_FORM : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(utils.gd_uname().isNotEmpty()){
            if(utils.gd_uname()!=utils.loadName()){
                utils.savePreferences("gd_uname1","")
                utils.savePreferences("gd_uname2","")
                utils.savePreferences("gd_uname3","")
                utils.savePreferences("gd_uname4","")
        ...
        if(utils.loadgd_uname1().isNotEmpty()){
            uname.setText(utils.loadgd_uname1())
        }

        if(utils.loadgd_uname2().isNotEmpty()){
            custname.setText(utils.loadgd_uname2())
        }
        if(utils.loadgd_uname3().isNotEmpty()){
            user3.setText(utils.loadgd_uname3())
        }
        ...
        if(utils.loadgd_uname1().isNotEmpty()&&
            utils.loadgd_uname2().isNotEmpty()&&
            utils.loadgd_uname3().isNotEmpty()&&
            utils.loadgd_uname4().isNotEmpty()&&
            utils.loadgd_uname5().isNotEmpty()&&
            utils.loadgd_uname6().isNotEmpty()){
...
/*        utils.savePreferences("gd_uname1",uname.text.toString().trim())
    ...
    private inner class     stateload : AsyncTask<String, Void, String>() {
        ...
        override fun onPreExecute() {
            ...
            pDialo = ProgressDialog(this@CMD_GOLD_FORM);
        ...
        override fun doInBackground(vararg param: String): String? {
            ...
            try {
                ...
                Log.i("check Input", Appconstants.gold + "    " + jobj.toString())
                result = con.sendHttpPostjson2(Appconstants.gold, jobj, "")
    ...
    private inner class savetask : AsyncTask<String, String, String>() {
        ...
        override fun onPreExecute() {
            progbar = Dialog(this@CMD_GOLD_FORM)
        ...
        override fun doInBackground(vararg param: String): String? {
            ...
            try {
                ...
                Log.i("checkInput feedback", Appconstants.gold + "    " + jobj.toString())
                result = con.sendHttpPostjson2(Appconstants.gold, jobj, "")
