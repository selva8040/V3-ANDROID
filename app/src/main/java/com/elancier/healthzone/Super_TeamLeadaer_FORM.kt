...
class Super_TeamLeadaer_FORM : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        head.setText("Super Team Leader")
        ...
        if(utils.loadfirstversion1()=="true"){
            utils.savePreferences("tl_uname1","")
            utils.savePreferences("tl_uname2","")
            utils.savePreferences("tl_uname3","")
            utils.savePreferences("tl_uname4","")
            utils.savePreferences("tl_uname5","")
            utils.savePreferences("tl_uname6","")
            utils.savePreferences("tl_uname","")
        }


        if(utils.tl_uname().isNotEmpty()){
            if(utils.tl_uname()!=utils.loadName()){
                utils.savePreferences("tl_uname1","")
                utils.savePreferences("tl_uname2","")
                utils.savePreferences("tl_uname3","")
                utils.savePreferences("tl_uname4","")
        ...
        if(utils.loadtl_uname1().isNotEmpty()){
            uname.setText(utils.loadtl_uname1())
        }

        if(utils.loadtl_uname2().isNotEmpty()){
            custname.setText(utils.loadtl_uname2())
        }
        if(utils.loadtl_uname3().isNotEmpty()){
            user3.setText(utils.loadtl_uname3())
        }
        if(utils.loadtl_uname4().isNotEmpty()){
            user4.setText(utils.loadtl_uname4())
        }
        if(utils.loadtl_uname5().isNotEmpty()){
            user5.setText(utils.loadtl_uname5())
        }
        if(utils.loadtl_uname6().isNotEmpty()){
            user6.setText(utils.loadtl_uname6())
        }


        if(utils.loadtl_uname1().isNotEmpty()&&
            utils.loadtl_uname2().isNotEmpty()&&
            utils.loadtl_uname3().isNotEmpty()&&
            utils.loadtl_uname4().isNotEmpty()&&
            utils.loadtl_uname5().isNotEmpty()&&
            utils.loadtl_uname6().isNotEmpty()){
    ...
    private inner class stateload : AsyncTask<String, Void, String>() {
        ...
        override fun onPreExecute() {
            ...
            pDialo = ProgressDialog(this@Super_TeamLeadaer_FORM);
        ...
        override fun doInBackground(vararg param: String): String? {
            ...
            try {
                ...
                Log.i("check Input", Appconstants.super_team_leader + "    " + jobj.toString())
                result = con.sendHttpPostjson2(Appconstants.super_team_leader, jobj, "")
                ...
                if (resp != null) {
                    ...
                    if (json.getString("Status") == "Success") {
                        ...
                        if(curentxt=="uname"){
                            // uname.setText("")
                            //click=""
                            utils.savePreferences("tl_uname1",uname.text.toString().trim())
                            utils.savePreferences("tl_uname",utils.loadName())
                            ...
                            //  custname.setText("")
                            utils.savePreferences("tl_uname2",custname.text.toString().trim())
                            utils.savePreferences("tl_uname",utils.loadName())
                            utils.savePreferences("clearversion1","false")
                            ...
                            // user3.setText("")
                            utils.savePreferences("tl_uname3",user3.text.toString().trim())
                            utils.savePreferences("tl_uname",utils.loadName())
                            utils.savePreferences("clearversion1","false")
                            ...
                            // user4.setText("")
                            utils.savePreferences("tl_uname4",user4.text.toString().trim())
                            utils.savePreferences("tl_uname",utils.loadName())
                            utils.savePreferences("clearversion1","false")
                            ...
                            //user5.setText("")
                            utils.savePreferences("tl_uname5",user5.text.toString().trim())
                            utils.savePreferences("tl_uname",utils.loadName())
                            utils.savePreferences("clearversion1","false")
                            ...
                            //user6.setText("")
                            utils.savePreferences("tl_uname6",user6.text.toString().trim())
                            utils.savePreferences("tl_uname",utils.loadName())
                            utils.savePreferences("clearversion1","false")
    ...
    private inner class savetask : AsyncTask<String, String, String>() {
        ...
        override fun onPreExecute() {
            progbar = Dialog(this@Super_TeamLeadaer_FORM)
        ...
        override fun doInBackground(vararg param: String): String? {
            ...
            try {
                ...
                Log.i("checkInput feedback", Appconstants.super_team_leader + "    " + jobj.toString())
                result = con.sendHttpPostjson2(Appconstants.super_team_leader, jobj, "")
