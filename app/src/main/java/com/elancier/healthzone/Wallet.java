...
public class Wallet extends MainView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            crore=getIntent().getExtras().getString("from");
        }
        catch (Exception e){
    ...
    private class GetInfoTask extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... param) {
            ...
            try {
                ...
                Log.i("utilsInput", Appconstants.WALLET+"    "+jobj.toString());
                result = con.sendHttpPostjson2(Appconstants.WALLET,jobj,"");
                ...
                if (resp != null) {
                    ...
                    if (obj1.getString("Status").equals("Success")) {
                        ...
                        for(int i=0;i<jarr.length();i++) {
                            ...
                            bo.setMode(jobj.getString("mode").toString().trim().equalsIgnoreCase("null")?"":jobj.getString("mode"));
                            bo.setType(jobj.getString("type").toString().trim().equalsIgnoreCase("null")?"0.00":jobj.getString("type"));
                            bo.setAmount(jobj.getString("amount").toString().trim().equalsIgnoreCase("null")?"0.00":jobj.getString("amount"));
                            bo.setBalance(jobj.getString("balance").toString().trim().equalsIgnoreCase("null")?"0.00":jobj.getString("balance"));
                        ...
                        WalletBookAdapter adapter=new WalletBookAdapter(Wallet.this,R.layout.wallet_book_list_item,passlist);
