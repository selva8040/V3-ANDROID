...
class CMD_SILVER_history : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState:Bundle?) {
        ...
        supportActionBar!!.title = "CMD SILVER REQUEST"
        ...
        addsalary.setOnClickListener{
            val k= Intent(this@CMD_SILVER_history,CMD_SILVER_FORM::class.java)
            startActivity(k)
        ...
        swipeToRefresh.setOnRefreshListener(object : SwipeRefreshLayout.OnRefreshListener {
            override fun onRefresh() {
                //shuffle()
                finish()
                startActivity(Intent(this@CMD_SILVER_history,CMD_SILVER_history::class.java))
    ...
    inner class RewardpointsAsync : AsyncTask<String, String, String>() {
        ...
        override fun doInBackground(vararg strings: String): String? {
            ...
            try {
                ...
                Log.i("silver", Appconstants.silver + "    " + jobj.toString())
